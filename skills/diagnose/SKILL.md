...
When exploring the codebase, use the project's domain glossary to get a clear mental model of the relevant modules, and check recorded decisions in the area you're touching.
...
**Then ask: what would have prevented this bug?** If the answer involves architectural change (no good test seam, tangled callers, hidden coupling), recommend a follow-up architecture pass with the specifics. Make the recommendation **after** the fix is in, not before, you have more information now than when you started.
